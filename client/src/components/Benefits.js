...
export default function Benefits(props) {
  return (
    <section className="key-benefits row">
      <div className="four columns centered full-height">
        <div className="key-benefit-card">
          <i className="fa fa-calendar-check-o" aria-hidden="true" />
          <h5>Get Organised</h5>
          <p>
            Our simple, easy to use design allows you to focus on your
            information and get organised.
          </p>
        </div>
      </div>
      <div className="four columns centered full-height">
      ...
      <div className="four columns centered full-height">
        <div className="key-benefit-card">
          ...
          <p>
            See how each note is connected and watch ideas jump out of the
            screen.
          </p>
        </div>
      </div>
